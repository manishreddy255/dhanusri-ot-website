...
const features = [
  {
    ...
    description: 'Every intervention is designed with the family in mind, ensuring sustainable progress at home.',
  },
  {
    icon: Award,
    title: 'Evidence-Based Practice',
    description: 'Using proven assessment tools and therapeutic approaches backed by research.',
  },
  {
    icon: Users,
    title: 'Multidisciplinary Collaboration',
    description: 'Working alongside speech therapists, physiotherapists, and psychologists for holistic care.',
  },
  {
    icon: BookOpen,
    title: 'Continuous Learning',
    description: 'Staying updated with the latest advancements in paediatric occupational therapy.',
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                I am Sarikonda Dhanusri, a Paediatric Occupational Therapist with over 4 years of clinical 
              ...
              <p>
                Currently based in Hyderabad, India, I offer comprehensive online assessments and video 
                consultations, making quality paediatric occupational therapy accessible to families 
                regardless of location. I am also eligible for HCPC registration in the UK.
              </p>
            </div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {['Sensory Integration', 'ASD', 'Cerebral Palsy', 'ADHD', 'Developmental Delays', 'Early Intervention'].map((tag) => (
                <span
                  key={tag}
                  className="px-4 py-2 bg-white border border-teal-200 text-teal-700 rounded-full text-sm font-medium"
                >
                  {tag}
                </span>
              ))}
